...
<p class="left difflink"><a href="?iframe=signlog&status=1">正在签名</a>(<em class="lightnum"><?php echo $signlog; ?></em>)</p>
...
<tr><td class="vtop td24 lineheight">版权所有</td><td><span class="bold"><a href="http://www.earcms.com" class="lightlink2" target="_blank">耳朵CMS</a></span></td></tr>
<tr><td class="vtop td24 lineheight">团队成员</td><td class="lineheight smallfont team"><a href="http://wpa.qq.com/msgrd?v=3&uin=136245992&site=EarCMS&menu=yes" target="_blank" class="lightlink2 smallfont">刘文韬</a></td></tr>
<tr><td class="vtop td24 lineheight">合作邮箱</td><td class="lineheight"><a href="mailto:web@earcms.com" target="_blank" class="lightlink2 smallfont">web@earcms.com</a></td></tr>
