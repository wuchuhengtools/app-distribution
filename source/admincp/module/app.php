...
<tr><td><input type="submit" class="btn" name="form2" id="btnsave" value="提交" onclick="return CheckForm();" /><?php if($signid){ ?><input class="checkbox" type="checkbox" id="signid" name="signid" value="<?php echo $signid; ?>" checked /><label for="signid">更新签名</label><?php } ?></td></tr>
</table>
</form>
</div>
